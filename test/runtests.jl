...
s2 = DB("~/Desktop/VCF/annotate/1027.db")

Nami.make_variant_table!(s2, "/Users/kate/Desktop/VCF/annotate/1027.clinvar.vcf.gz")

# ---- #

# 4.576662 seconds (16.90 M allocations: 1.328 GiB, 3.21% gc time)
# 85.921542 seconds (324.11 M allocations: 24.881 GiB, 2.42% gc time)

for (sq, ba, re) in (
    (SQ, "thin.10K.vcf.gz", 17900000),
